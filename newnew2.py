...
with open("release date2.csv", newline='') as f:
    reader = csv.reader(f)
...
for game in search_keywords:
    ...
    release_date = MobileScrap.get_release_date(games[0], games[1], "HVY0219103001244")
    temp.append(games[0])
    temp.append(games[1])
...
writer = pd.ExcelWriter('{}.xlsx'.format("Games Release Date2"), engine='xlsxwriter')
